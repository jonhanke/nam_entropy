...
class DatasetConfig(BaseModel):
    """Configuration for dataset loading and structure."""
    
    # HuggingFace data information
    task_repo: str = 'hcoxec/french_german_mix'
    ...
    @field_validator('data_column_name_list')
    @classmethod
    def validate_column_list(cls, v):
        if not v or len(v) == 0:
            raise ValueError("data_column_name_list must contain at least one column name")
        return v
